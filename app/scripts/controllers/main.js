...
.controller('MainCtrl', function ($scope, Lightbox) {
    $scope.homeImages = [
      ...
      {'width': '540', 'height': '361', 'url': 'images/albcard.png','image': 'images/albcard.png','text': 'Zusätzlich gibt es die AlbCard (www.albcard.de) geschenkt, mit der Sie kostenfrei den öffentlichen Personenverkehr und viele Attraktionen der Region geniesen.'}
    ];
